...
public class CasePromotionController {
    ...
    public R<Map<String, Object>> getAnalysisStatus(@PathVariable String taskId) {
     ...
     */
    @GetMapping("/{id}")
    public R<CasePromotion> getById(@PathVariable Long id) {
    ...
    public R<CasePromotion> getByCaseId(@PathVariable String caseId) {
     ...
     */
    @GetMapping("/list")
    public R<PageResult<CasePromotionVO>> list(CasePromotionSearchDTO dto) {
